...
class Master_matakuliah extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Master_matakuliah_model');
    ...
    {
        $data = array(
            'konten' => 'master_matakuliah/view',
            'judul_page' => 'Master Matakuliah',
        );
        ...
        // $config['total_rows'] = $this->Master_matakuliah_model->total_rows($q);
        // $matakuliah = $this->Master_matakuliah_model->get_limit_data($config['per_page'], $start, $q);
        ...
        //     'start' => $start,
        //     'judul_page' => ' master matakuliah/matakuliah_list',
        //     'konten' => 'master_matakuliah/matakuliah_list',
        // );
        // $this->load->view('v_index', $data);
    }
    ...
    {
        $row = $this->Master_matakuliah_model->get_by_id($id);
        if ($row) {
            $data = array(
        'id_mk' => $row->id_mk,
        'kode_mk' => $row->kode_mk,
        ...
        'id_kurikulum' => $row->id_kurikulum,
            ...
            redirect(site_url('master_matakuliah'));
        }
    }
    ...
    public function create_action() 
    {
        ...
        'id_kurikulum' => $this->input->post('id_kurikulum',TRUE),
            ...
            $this->Master_matakuliah_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'judul_page' => 'Ubah Master Matakuliah',
                'konten' => 'master_matakuliah/matakuliah_form',
                'button' => 'Ubah',
                'action' => site_url('master_matakuliah/update_action'),
    ...
    public function update_action() 
    {
        ...
        'id_prodi' => $this->input->post('id_prodi',TRUE)
            ...
            $this->Master_matakuliah_model->update($this->input->post('id_mk', TRUE), $data);
            $this->session->set_flashdata('message', '<div class="alert alert-success fade in alert-radius-bordered alert-shadowed">
                                        <button class="close" data-dismiss="alert">
                                            ×
                                        </button>
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Master_matakuliah_model->delete($id);
            $this->session->set_flashdata('message', '<div class="alert alert-success fade in alert-radius-bordered alert-shadowed">
                                        <button class="close" data-dismiss="alert">
                                            ×
                                        </button>
