                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    <li class="username"><a><?php echo $this->session->userdata('username'); ?></a></li>
                                    ...
                                    <!--Avatar Area-->
                                    <li class="edit">
                                        <a href="app/profil" class="pull-left">Profile</a>
                                        <a href="login/logout" class="pull-right">Keluar</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
