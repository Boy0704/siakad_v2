...
if ($_GET) {
	...
	header("Content-Disposition: attachment; filename=Export_KHS.xls");
 ?>
...
<table border="1">
	<tr>
		...
		<td style="background-color: red">HURUF</td>
		<td style="background-color: red">INDEKS</td>
		<td style="background-color: red">ANGKA</td>
