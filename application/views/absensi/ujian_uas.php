...
<?php if ($abs_uas == 't'): ?>
    ...
    <?php echo alert_notif('Tidak ada Ujian UAS yang aktif di periode ini !','danger') ?>

<?php else: ?>

<div style="margin-bottom: 10px;">
    <a href="cetak/cetak_kum/<?php echo $data_mhs->nim ?>/<?php echo tahun_akademik_aktif('kode_tahun') ?>/<?php echo $jenis_ujian ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak KUM UAS</a>
</div>
...
<table align="center" class="table table-bordered">
    <tr>
        <td align="center" colspan="8" style="font-size: 16px;">
            <strong><u>KARTU ABSEN UJIAN UAS</u></strong>
        </td>
    </tr>
    <tr>
...
<br><br>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        $kode_semester = tahun_akademik_aktif('kode_tahun');
            $this->db->select('a.*,b.uas_mhs,b.date_uas_mhs');
            $this->db->from('krs a');
            ...
            foreach ($this->db->get()->result() as $br): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <a onclick="javasciprt: return confirm('Yakin akan isi absen ujian uas ?')" href="absensi/hadir_ujian/<?php echo $jenis_ujian ?>?nim=<?php echo $br->nim ?>&id_krs=<?php echo $br->id_krs ?>" class="label label-info">Hadir</a>
                        <?php endif ?>
